...
-- ============================================================
-- Price History Table
-- Tracks historical pricing for products across retailers
-- ============================================================
...
drop policy if exists "authenticated can insert price history" on price_history;
create policy "authenticated can insert price history"
  on price_history for insert
  with check (auth.role() = 'authenticated');

drop policy if exists "authenticated can update price history" on price_history;
create policy "authenticated can update price history"
